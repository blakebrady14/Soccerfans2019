...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        this.preStart.previous = this.preStart;
        /**
         * Last node of doubly linked list in this.left.
         */
        ...
        this.postFinish.next = this.postFinish;
    ...
    public final void addRightFront(T x) {
        ...
        right.next = this.lastLeft.next;
        //this.lastLeft
        this.lastLeft.next = right;
        right.previous = this.lastLeft;
    ...
    public final T removeRightFront() {
        ...
        Node right = this.lastLeft.next;
        this.lastLeft.next = right.next;
        right.next.previous = this.lastLeft;
        right.next = null;
        right.previous = null;
        this.rightLength--;
        assert this.conventionHolds();
