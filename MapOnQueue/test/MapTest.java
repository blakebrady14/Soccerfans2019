 ...
 *
 */
public abstract class MapTest extends MapSecondary {
    /**
    ...
    public void testRemoveEmptyAfter() {
        ...
        Pair<String, String> check = new SimplePair<>("joe", "bill");
    ...
    public void testRemoveFullAfter() {
        ...
        Map<String, String> n1 = this.createFromArgsTest("joe", "bill", "harry",
                "james");
        Pair<String, String> check = new SimplePair<>("joe", "bill");
        Map<String, String> n1Expected = this.createFromArgsTest("harry",
                "james");
