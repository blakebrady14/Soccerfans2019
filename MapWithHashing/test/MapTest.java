...
public abstract class MapTest {
    ...
    /*
     * Testing constructor with one pair
     */
    @Test
    public void testEmptyConstructorWithOnePair() {
    ...
    /*
     * Testing constructor with two pairs
     */
    @Test
    public void testEmptyConstructorWithTwoPairs() {

        /*
         * Setup/The call
         */
        Map<String, String> n1 = this.createFromArgsTest("bill", "joe", "bob",
                "sally");
        Map<String, String> n1Expected = this.createFromArgsRef("bill", "joe",
                "bob", "sally");
    ...
    /*
     * Testing the add method when n1 has one pair
     */
    @Test
    ...
    /*
     * Testing the add method when n1 has two pairs
     */
    @Test
    public void testAddTwoPairs() {
         ...
         * Setup
         */
        Map<String, String> n1 = this.createFromArgsTest("bill", "joe", "green",
                "blue");
        Map<String, String> n1Expected = this.createFromArgsRef("bill", "joe",
                "green", "blue", "sam", "john");
    ...
    /*
     * Testing the rempve method when n1 has one pair after the call
     */
    @Test
    public void testRemoveOnePairAfter() {
    ...
    /*
     * Testing the rempve method when n1 has two pairs after the call
     */
    @Test
    public void testRemoveTwoPairsAfter() {

        /*
         * Setup
         */
        Map<String, String> n1 = this.createFromArgsTest("joe", "bill", "green",
                "blue", "harry", "james");
        Map<String, String> n1Expected = this.createFromArgsRef("green", "blue",
                "harry", "james");
    ...
    /*
     * Testing the removeAny method when n1 has one pair after the removeAny
     * call
     */
    @Test
    public void testRemoveAnyOnePairAfter() {
    ...
    /*
     * Testing the removeAny method when n1 has two pairs after the removeAny
     * call
     */
    @Test
    public void testRemoveAnyTwoPairsAfter() {
    ...
    /*
     * Testing the value method with three pair entry
     */
    @Test
    public void testValueThreeCheck() {
    ...
    /*
     * Testing the hasKey method with three pair entry
     */
    @Test
    public void testHasKeyThreeCheck() {
    ...
    /*
     * Testing the hasKey method without the key in it
     */
    @Test
    public void testHasKeyNotInMap() {
    ...
    /*
     * Testing the size method when n1 is empty
     */
    @Test
    ...
    /*
     * Testing the size method with one pair
     */
    @Test
    public void testSizeOnePair() {
    ...
    /*
     * Testing the size method with twpo pairs
     */
    @Test
    public void testSizeTwoPair() {

        /*
         * Setup
         */
        Map<String, String> n1 = this.createFromArgsTest("joe", "bill", "blue",
                "green");
        Map<String, String> n1Expected = this.createFromArgsTest("joe", "bill",
                "blue", "green");
