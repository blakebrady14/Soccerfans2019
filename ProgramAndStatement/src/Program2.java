...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        ...
        /*
         * Using "Unnamed" bc the slides use that for the default value
         */
        this.name = "Unnamed";
    ...
    public final Map<String, Statement> newContext() {
        ...
        /*
         * Returning new instance of this.context
         */
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        /*
         * Tried doing this with only =, but for some reason it doesnt work but
         * it does when i use transferfrom. Not sure whats going on, guessing
         * its an alias problem
         */
    ...
    public final Statement newBody() {
        ...
        /*
         * Returning new instance of this.body
         */
