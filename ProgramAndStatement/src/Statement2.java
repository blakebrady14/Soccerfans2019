...
public class Statement2 extends StatementSecondary {
    ...
    public final Kind kind() {
        ...
        /*
         * For all of these methods, need to remember that this.rep is a TREE,
         * so treat it as such
         */
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        /*
         * Creating new Statement2 variable from s, so s.rep can be used
         */
        ...
        /*
         * Creating a new rep so the contract is upheld
         */
        localS.createNewRep();
